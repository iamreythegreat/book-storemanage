...
--
-- Host: localhost
-- Generation Time: Sep 26, 2022 at 01:00 AM
...
CREATE TABLE `books` (
  ...
  `status` varchar(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
...
(32, 'The Legend 2', 'Unknown', 2022, 1, NULL);
